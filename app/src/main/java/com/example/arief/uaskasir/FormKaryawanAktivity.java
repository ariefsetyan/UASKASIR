...
public class FormKaryawanAktivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    private String url = Server.URL + "insertkary.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_karyawan_aktivity);
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (conMgr.getActiveNetworkInfo() != null
                        && conMgr.getActiveNetworkInfo().isAvailable()
                        && conMgr.getActiveNetworkInfo().isConnected()) {
                    checkKaryawan(Nama,Alamat,Email,Nomer);
                } else {
    ...
    private void checkKaryawan(final String Nama, final String Alamat,final String Email, final String Nomer) {
...
//                hideDialog();
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        nomer.setText("");
//kjlskf
                        intent = new Intent(FormKaryawanAktivity.this, SupplierActivity.class);
                        finish();
